                    ...
                    if col != '-1':
                        ...
                        if style == 'entities':
                            if col == '394':
                                ...
                                Enemey(monster_name,(x,y),[self.visible_sprites,self.attackable_sprites],self.obstacle_sprites, self.damage_player, self.trigger_death_particles, self.add_exp)
...
class YSortCameraGroup(pygame.sprite.Group):
    def __init__(self):
        ...
        #creando el suelo
        self.floor_surface = pygame.image.load('Map/ground.png').convert()
